...
function testConfig(overrides: Partial<Config> = {}): Config {
  return Object.freeze({
    ...
    systemPromptDirAbsolutePath: '/tmp/test/cms/prompts/system',
    skillsDirAbsolutePath: '/tmp/test/cms/prompts/skills',
    toolsPromptDirAbsolutePath: '/tmp/test/cms/prompts/tools',
    handoffTemplatesDirAbsolutePath: '/tmp/test/cms/templates/handoff',
    isProduction: false,
    ...overrides,
  }) as Config;
}
