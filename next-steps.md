...
7. ~~**C.t8** — ETL + annotation runbooks~~ ✅ **done 2026-05-02.** Six runbooks at `handover/ops/`: `etl-rerun.md`, `embedding-rerun.md`, `image-annotation-rerun.md`, `migration-management.md`, `prompt-version-rollback.md`, `troubleshooting.md`. Plus index `README.md`.
