...
**Workspaces touched**: `@swoop/orchestrator` (primary), `@swoop/connector` (migration file only — single migrate runner), config schema, `handover/ops` runbook note.
