...
After both relocations, `product/cms/` holds only runtime-agent-readable content (`prompt-defaults/`, `template-defaults/`). Operator runbooks live in `handover/ops/` (developer docs, not app content).
